  ...
  ### Scatter plots
  #par(mfrow=c(4,2))
    graphics::plot(PMSO ~ X1, data=db, pch=19, col="dark blue", main =  ""); title(main = "PMSO x X1")
    graphics::plot(PMSO ~ X2, data=db, pch=19, col="red", main =""); title(main = "PMSO x X2")
    graphics::plot(PMSO ~ X3, data=db, pch=19, col="green", main =""); title(main = "PMSO x X3")
    graphics::plot(PMSO ~ X4, data=db, pch=19, col="cyan", main =""); title(main = "PMSO x X4")
    graphics::plot(PMSO ~ X5, data=db, pch=19, col="grey",main =""); title(main = "PMSO x X5")
    graphics::plot(PMSO ~ X6, data=db, pch=19, col="orange",main =""); title(main = "PMSO x X6")
    graphics::plot(PMSO ~ X7, data=db, pch=19, col="purple", main =""); title(main = "PMSO x X7")
    graphics::plot(PMSO ~ X8, data=db, pch=19, col="black",main =""); title(main = "PMSO x X8")
    
    with(db, scatterplot3d(X1, Ano, PMSO/1000, color = "blue", pch = 19
                           , main = "3D Scatter Plot",angle =140)) 
  ...
  graphics::plot(yfit ~ db$PMSO, pch=19, col="blue", ylab="estimated PMSO", 
  ...
  # par(mfrow=c(4,2))
    graphics::plot(PMSO ~ X1, data=db, pch=19, col="dark blue");title(main = "PMSO x X1")
    abline(a=dados_regressoes[1,1], b=dados_regressoes[2,1], lwd=2,lty = 2, col="red")
  
    graphics::plot(PMSO ~ X2, data=db, pch=19, col="black");title(main = "PMSO x X2")
    abline(a=dados_regressoes[1,2], b=dados_regressoes[2,2], lwd=2,lty = 2, col="red")
    
    graphics::plot(PMSO ~ X3, data=db, pch=19, col="green");title(main = "PMSO x X3")
    abline(a=dados_regressoes[1,3], b=dados_regressoes[2,3], lwd=2,lty = 2, col="red")
    
    graphics::plot(PMSO ~ X4, data=db, pch=19, col="cyan");title(main = "PMSO x X4")
    abline(a=dados_regressoes[1,4], b=dados_regressoes[2,4], lwd=2,lty = 2, col="red")
    
    graphics::plot(PMSO ~ X5, data=db, pch=19, col="grey");title(main = "PMSO x X5")
    abline(a=dados_regressoes[1,5], b=dados_regressoes[2,5], lwd=2,lty = 2, col="red")
    
    graphics::plot(PMSO ~ X6, data=db, pch=19, col="orange");title(main = "PMSO x X6")
    abline(a=dados_regressoes[1,6], b=dados_regressoes[2,6], lwd=2,lty = 2, col="red")
    
    graphics::plot(PMSO ~ X7, data=db, pch=19, col="purple");title(main = "PMSO x X7")
    abline(a=dados_regressoes[1,7], b=dados_regressoes[2,7], lwd=2,lty = 2, col="red")
    
    graphics::plot(PMSO ~ X8, data=db, pch=19, col="blue");title(main = "PMSO x X8")
